class Automobile {
    ...
    get chilometraggioAttuale() {
        return `Il chilometraggio attuale è ${this.chilometraggio} km.`;
    }
...
console.log(auto1.mostraContatoreChiamate()); // Mostra il numero di volte che il metodo è stato chiamato